...
const _categories  = ['All Categories', 'OUTERWEAR', 'JACKETS'];
const _sortOptions = ['Default', 'Price: Low to High', 'Price: High to Low', 'Name: A to Z', 'Name: Z to A', 'Newest First'];

class OuterwearPage extends StatefulWidget {
  final String? userEmail;
  const OuterwearPage({super.key, this.userEmail});
  @override
  State<OuterwearPage> createState() => _OuterwearPageState();
}

class _OuterwearPageState extends State<OuterwearPage> {
  ...
  SliverAppBar _appBar() => SliverAppBar(
    ...
    title: ShaderMask(
      ...
      child: const Text('Outerwear & Jackets', style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.w800, letterSpacing: 0.5)),
    ),
    actions: [
  ...
  Widget _heroSection() {
    final slides = [
      {'title': "Men's", 'highlight': 'Outerwear', 'sub': 'Stay warm and stylish for every season.'},
      {'title': 'Style &', 'highlight': 'Protection', 'sub': 'Premium jackets and coats crafted for you.'},
    ];
              ...
              child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
                Container(
                  ...
                  child: Row(mainAxisSize: MainAxisSize.min, children: const [
                    ...
                    SizedBox(width: 4),
                    Text('Premium Outerwear Collection', style: TextStyle(color: _primary, fontWeight: FontWeight.w800, fontSize: 8, letterSpacing: 0.8)),
                  ]),
                ),
          ...
          Expanded(
            ...
            child: Container(
              decoration: const BoxDecoration(
                gradient: LinearGradient(begin: Alignment.topLeft, end: Alignment.bottomRight, colors: [Color(0xFF1c2333), Color(0xFF2d3a4a)]),
              ),
              child: Stack(alignment: Alignment.center, children: [
                ...
                const Icon(Icons.layers, size: 64, color: Color(0xFF3a4a5a)),
                ...
                Positioned(bottom: 24, left: 10,
                  child: Container(
                    ...
                    child: const Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Text('Outerwear', style: TextStyle(color: Colors.white70, fontSize: 8)),
                      Text('From ₱1,699.00', style: TextStyle(color: _gold, fontWeight: FontWeight.w800, fontSize: 12)),
                    ]),
                  ),
                ),
              ]),
  ...
  Widget _productGrid() => Container(
    ...
    child: Column(children: [
      const Text('Outerwear & Jackets', style: TextStyle(color: _accent, fontSize: 20, fontWeight: FontWeight.w800, letterSpacing: -0.5)),
      const SizedBox(height: 8),
