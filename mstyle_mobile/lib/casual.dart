...
const _categories  = ['All Categories', 'SHIRTS', 'PANTS'];
...
class CasualPage extends StatefulWidget {
  ...
  const CasualPage({super.key, this.userEmail});
  @override
...
class _CasualPageState extends State<CasualPage> {
  ...
  SliverAppBar _appBar() => SliverAppBar(
    ...
    title: ShaderMask(
      ...
      child: const Text('Casual Shirts & Pants',
  ...
  Widget _heroSection() {
    final slides = [
      {'title': "Men's", 'highlight': 'Casual Wear', 'sub': 'Discover comfort and style in our curated casual collection.'},
      {'title': 'Comfort', 'highlight': '& Elegance', 'sub': 'Premium shirts and pants for everyday wear.'},
    ];
              ...
              child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
                Container(
                  ...
                  child: Row(mainAxisSize: MainAxisSize.min, children: const [
                    ...
                    SizedBox(width: 4),
                    Text('Premium Casual Collection', style: TextStyle(color: _primary, fontWeight: FontWeight.w800, fontSize: 8, letterSpacing: 0.8)),
                  ]),
                ),
          ...
          Expanded(
            ...
            child: Container(
              decoration: const BoxDecoration(
                gradient: LinearGradient(begin: Alignment.topLeft, end: Alignment.bottomRight, colors: [Color(0xFF1a1a2e), Color(0xFF2d2d4a)]),
              ),
              child: Stack(alignment: Alignment.center, children: [
                ...
                const Icon(Icons.checkroom, size: 64, color: Color(0xFF4a4a7a)),
                ...
                Positioned(bottom: 24, left: 10,
                  child: Container(
                    ...
                    child: const Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Text('Casual Wear', style: TextStyle(color: Colors.white70, fontSize: 8)),
                      Text('From ₱799.00', style: TextStyle(color: _gold, fontWeight: FontWeight.w800, fontSize: 12)),
                    ]),
                  ),
                ),
              ]),
  ...
  Widget _productGrid() => Container(
    ...
    child: Column(children: [
      const Text('Casual Wear', style: TextStyle(color: _accent, fontSize: 20, fontWeight: FontWeight.w800, letterSpacing: -0.5)),
      const SizedBox(height: 8),
      ...
      builder: (_) => StatefulBuilder(builder: (ctx, setS) => Padding(
        ...
        child: Container(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            const SizedBox(height: 16),
            Row(children: [
              const Icon(Icons.bolt, color: _gold, size: 18), const SizedBox(width: 8),
            ...
            GestureDetector(
              ...
              child: Container(width: double.infinity, padding: const EdgeInsets.symmetric(vertical: 15),
                decoration: BoxDecoration(gradient: _premiumGrad, borderRadius: BorderRadius.circular(14), boxShadow: [BoxShadow(color: _primary.withOpacity(0.3), blurRadius: 12, offset: const Offset(0, 4))]),
                child: const Row(mainAxisAlignment: MainAxisAlignment.center, children: [Icon(Icons.bolt, color: _gold, size: 16), SizedBox(width: 8), Text('Proceed to Checkout', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w800, fontSize: 14))])),
            ),
          ]),
        ),
      )),
