...
class _ShoesPageState extends State<ShoesPage> {
  ...
  SliverAppBar _appBar() => SliverAppBar(
    ...
    title: ShaderMask(
      ...
      child: const Text('Shoes & Accessories', style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.w800, letterSpacing: 0.5)),
    ),
    actions: [
  ...
  Widget _heroSection() {
    final slides = [
      {'title': "Men's", 'highlight': 'Shoes & Accessories', 'sub': 'Step up your style with premium footwear.'},
      {'title': 'Quality &', 'highlight': 'Comfort', 'sub': 'Crafted for every step you take.'},
    ];
              ...
              child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
                Container(
                  ...
                  child: Row(mainAxisSize: MainAxisSize.min, children: const [
                    Icon(Icons.shopping_bag, color: _primary, size: 10),
                    SizedBox(width: 4),
                    Text('Premium Shoes & Accessories', style: TextStyle(color: _primary, fontWeight: FontWeight.w800, fontSize: 8, letterSpacing: 0.8)),
                  ]),
                ),
          ...
          Expanded(
            ...
            child: Container(
              decoration: const BoxDecoration(
                gradient: LinearGradient(begin: Alignment.topLeft, end: Alignment.bottomRight, colors: [Color(0xFF2a1a0a), Color(0xFF3d2b1a)]),
              ),
              child: Stack(alignment: Alignment.center, children: [
                ...
                const Icon(Icons.shopping_bag, size: 64, color: Color(0xFF6a4a2a)),
                ...
                Positioned(bottom: 24, left: 10,
                  child: Container(
                    ...
                    child: const Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Text('Shoes & Accessories', style: TextStyle(color: Colors.white70, fontSize: 8)),
                      Text('From ₱899.00', style: TextStyle(color: _gold, fontWeight: FontWeight.w800, fontSize: 12)),
                    ]),
                  ),
                ),
              ]),
  ...
  Widget _productGrid() => Container(
    ...
    child: Column(children: [
      const Text('Shoes & Accessories', style: TextStyle(color: _accent, fontSize: 20, fontWeight: FontWeight.w800, letterSpacing: -0.5)),
      const SizedBox(height: 8),
