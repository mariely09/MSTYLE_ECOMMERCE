              ...
              child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
                Container(
                  ...
                  child: Row(mainAxisSize: MainAxisSize.min, children: const [
                    ...
                    SizedBox(width: 4),
                    Text('Premium Suits Collection', style: TextStyle(color: _primary, fontWeight: FontWeight.w800, fontSize: 8, letterSpacing: 0.8)),
                  ]),
                ),
          ...
          Expanded(
            ...
            child: Container(
              decoration: const BoxDecoration(
                gradient: LinearGradient(begin: Alignment.topLeft, end: Alignment.bottomRight, colors: [Color(0xFF0d1b2a), Color(0xFF1b2a3b)]),
              ),
              child: Stack(alignment: Alignment.center, children: [
                ...
                const Icon(Icons.person, size: 64, color: Color(0xFF2a4a6a)),
                ...
                Positioned(bottom: 24, left: 10,
                  child: Container(
                    ...
                    child: const Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Text('Premium Suits', style: TextStyle(color: Colors.white70, fontSize: 8)),
                      Text('From ₱2,899.00', style: TextStyle(color: _gold, fontWeight: FontWeight.w800, fontSize: 12)),
                    ]),
                  ),
                ),
              ]),
