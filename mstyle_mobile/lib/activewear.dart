          ...
          Expanded(
            ...
            child: Container(
              decoration: const BoxDecoration(
                gradient: LinearGradient(begin: Alignment.topLeft, end: Alignment.bottomRight, colors: [Color(0xFF1a2a1a), Color(0xFF2d4a2d)]),
              ),
                ...
                Positioned(bottom: 24, left: 10,
                  child: Container(
                    ...
                    child: const Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Text('Performance Gear', style: TextStyle(color: Colors.white70, fontSize: 8)),
                      Text('From ₱749.00', style: TextStyle(color: _gold, fontWeight: FontWeight.w800, fontSize: 12)),
                    ]),
                  ),
                ),
              ]),
